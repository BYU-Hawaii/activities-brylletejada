document.getElementById('registrationForm').addEventListener('submit', function(event) {
    ...
    var phoneValid = /^[0-9]{10,}$/.test(phone); //Check Phone Number
    ...
    document.getElementById('phoneFeedback').textContent = phoneValid ? '' : 'Phone Number could only be numbers and at least 10 numbers long.';
    ...
    if (formValid) {
        ...
        document.getElementById('registrationFeedback').textContent = 'Error: Please check your form.';
